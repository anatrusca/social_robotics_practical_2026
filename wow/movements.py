...
SPEAK_CYCLES = [
    [
        ...
        {"time": 0.4, "data": {"body.head.yaw": 0.10}},
        {"time": 1.2, "data": {"body.head.yaw": -0.10}},
        {"time": 2.0, "data": {"body.head.pitch": 0.0, "body.head.yaw": 0.0}},
    ],
    [
        {"time": 0.0, "data": {"body.head.pitch": 0.06}},
        {"time": 0.5, "data": {"body.head.pitch": -0.06}},
        {"time": 1.0, "data": {"body.head.pitch": 0.06}},
        {"time": 1.5, "data": {"body.head.pitch": -0.06}},
        {"time": 2.0, "data": {"body.head.pitch": 0.0}},
    ],
]
...
WRONG_FRAMES = [
    ...
    {"time": 0.9 * delta_t, "data": {
        "body.head.yaw": -0.18
    }},
    {"time": 1.3 * delta_t, "data": {
        "body.head.yaw": 0.12
    }},
    {"time": 1.7 * delta_t, "data": {
        "body.head.yaw": 0.0
    }},
